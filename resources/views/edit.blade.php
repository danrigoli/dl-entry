    ...
    <form id="form" method="" action="{{route('update', $legislator->id)}}">
        ...
        <div class="row">
            ...
            <div class="input-group col mb-3">
                ...
                <input type="tel" id="cellphone" value="{{$legislator->cellphone}}" name="cellphone" class="form-control" placeholder="Ingresar el telefono del legislador..." aria-label="cellphone">
        ...
        <div class="row"> 
            ...
            <div class="input-group col mb-3">
                ...
                @if ($errors->has('country'))
                    <script>country.setAttribute("class", "is-invalid form-control")</script>
