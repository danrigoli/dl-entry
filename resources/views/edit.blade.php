...
@section('content')
<div class="container">
    <h1 class="title">Edita un Legislador!</h1>
    <form id="form" method="" action="{{route('update', $legislator->id)}}">
        @csrf
        {{ csrf_field() }}
        @method("PUT")
        <div class=row>
            <div class="input-group col-lg-6 col-md-12 mb-3">
                ...
                <input type="text" id="username" value="{{$legislator->name}}" name="name" class="form-control" placeholder="Ingresar el nombre del legislador..." aria-label="name">
                <p id="errorName"></p>
            </div>
            <div class="input-group col mb-3">
                ...
                <input type="text" id=surname value="{{$legislator->surname}}" name="surname" class="form-control" placeholder="Ingresar el apellido del legislador..." aria-label="surname">
                <p id="errorSurname"></p>
            </div>
        </div>
        <div class="row">
            <div class="input-group col-lg-6 col-md-12 mb-3">
                ...
                <input type="text" id=email value="{{$legislator->email}}" name="email" class="form-control" placeholder="Ingresar el email del legislador..." aria-label="email">
                @if ($errors->has('email'))
            ...
            <div class="input-group col mb-3">
                ...
                <input type="number" id="cellphone" value="{{$legislator->cellphone}}" name="cellphone" class="form-control" placeholder="Ingresar el telefono del legislador..." aria-label="cellphone">
        ...
        <div class="row"> 
            <div class="input-group col-lg-6 col-md-12 mb-3">
                ...
                <input type="text" value="{{$legislator->address}}" name="address" class="form-control" placeholder="Ingresar la direccion del legislador..." aria-label="address">
            </div>
            <div class="input-group col mb-3">
                <div class="input-group-prepend">
                ...
                <input type="text" id="country" value="{{$legislator->country}}" name="country" class="form-control" placeholder="Ingresar el pais del legislador..." aria-label="country">
                <p id="errorCountry"></p>
            </div>
        </div>
        <div class="row">
            ...
            <input type="number" id="votes" value='{{$legislator->votes}}' name="votes" class="form-control" placeholder="Ingresar la cantidad de votos del legislador..." aria-label="votes">
                <p id="errorVotes"></p>
            </div>
            <div class="input-group col mb-3">
                <div class="input-group-prepend">
                ...
                <select id="party" name="party" type="text" class="form-control">
                    <option value=null selected>Elegir partido politico</option>
        ...
        <div class="row">
            <div class="input-group col-lg-6 col-md-12 mb-3">
                ...
                <input type="date" id='starting' value='{{$legislator->starting}}' name="starting" class="form-control" aria-label="starting" required>
            </div>
                <div class="mb-3 col">
                <button type="submit" class="btn btn-dark">Editar legislador</button>
                </div>
        </div>
